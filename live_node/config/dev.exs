...
config :live_node, LiveNodeWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "eS+T+rsfZtYHaI/u40KECHMTLUXu9FIAOIn38LobzYd5WZ8KHzx4t1jHRYhEG5IV",
  watchers: [
...
config :live_node, LiveNodeWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/live_node_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :live_node, dev_routes: true
...
config :live_node, :uploads_dir, "./temp/"
